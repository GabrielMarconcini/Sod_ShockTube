...
#Dados Wolfdynamics solution (PIMPLE) 100 células:
arq8 = open('/home/gabrielmarconcini/Documentos/TCC/PTCC/ShockTube/SodShockTube/PimpleFoam/shockTube_fvSch1_100/data_fvSch1_100.csv','r')
magU_fvSch1_100,p_fvSch1_100,rho_fvSch1_100,x_fvSch1_100 = np.loadtxt(arq8, delimiter=',', dtype='float', comments='#', usecols=(4, 5, 6, 9), unpack=True, skiprows=1)
arq8.close()

#Dados Wolfdynamics solution (PIMPLE) 1000 células:
arq9 = open('/home/gabrielmarconcini/Documentos/TCC/PTCC/ShockTube/SodShockTube/PimpleFoam/shockTube_fvSch1_1000/data_fvSch1_1000.csv','r')
magU_fvSch1_1000,p_fvSch1_1000,rho_fvSch1_1000,x_fvSch1_1000 = np.loadtxt(arq9, delimiter=',', dtype='float', comments='#', usecols=(4, 5, 6, 9), unpack=True, skiprows=1)
arq9.close()

#Dados Wolfdynamics solution (PIMPLE) 10000 células:
arq10 = open('/home/gabrielmarconcini/Documentos/TCC/PTCC/ShockTube/SodShockTube/PimpleFoam/shockTube_fvSch1_10000/data_fvSch1_10000.csv','r')
magU_fvSch1_10000,p_fvSch1_10000,rho_fvSch1_10000,x_fvSch1_10000 = np.loadtxt(arq10, delimiter=',', dtype='float', comments='#', usecols=(4, 5, 6, 9), unpack=True, skiprows=1)
arq10.close()
...
plt.plot(x_fvSch1_10000,p_fvSch1_10000, label='rhoPimpleFoam - fvSch 1')
...
plt.plot(x_fvSch1_1000,p_fvSch1_1000, label='rhoPimpleFoam - fvSch 1')
plt.plot(x_py, p_py, label='Analítica')
...
plt.plot(x_fvSch1_100,p_fvSch1_100, label='rhoPimpleFoam - fvSch 1')
plt.plot(x_py, p_py, label='Analítica')
